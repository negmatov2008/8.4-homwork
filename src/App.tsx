...
function App() {
  ...
  const [yil, setYil] = useState<string | undefined>();
  const [oy, setOy] = useState<string | undefined>();
  ...
  const Qachon = (data: string | undefined) => {
    const yill: string | undefined = data?.slice(0, 4);
    setYil(yill);
    const mounth: string | undefined = data?.slice(5, 7);
    let sana: string = "";
    ...
    setOy(sana);
    const kun: string | undefined = data?.slice(8, 10);
    setDay(kun);
  };

  useEffect(() => {
    Qachon(Api?.created_at);
    getApi();
  }, [Api?.created_at]);
    ...
    <>
      <div className="max-w-[321px] mx-auto md:max-w-[573px] lg:max-w-[730px] ">
        ...
        {Api ? (
              ...
              <div>
                <div className="mb-[34px] md:mb-[24px] flex gap-[19px] items-center">
                  ...
                  <div className="flex flex-col gap-[6px] lg:max-w-[480px] lg:flex-row lg:gap-[127px] ">
                    <div>
                      <h1 className="font-bold md:text-[26px]">{Api?.name}</h1>
                      <span>
                        <a
                          target="_blank"
                  ...
                  <div className="flex flex-col gap-[17px]">
                    ...
                    <div className="flex gap-[13.25px] items-center">
                      ...
                      <span className="text-[#4B6A9B] text-[13px] dark:text-[#fff] md:text-[15px]">
                        <a
                          target="_blank"
                          href={Api?.blog == "__" ? "" : Api.blog}
                        >
                          {Api?.blog == "__" ? "Not Available" : Api.blog}
                        </a>
                      </span>
                    </div>
                  </div>
                  <div className="flex flex-col gap-[17px]">
                    ...
                    <div className="flex gap-[13.25px] items-center">
                      ...
                      <span className="text-[#4B6A9B] text-[13px] dark:text-[#fff] md:text-[15px]">
                        <a
                          target="_blank"
                          href={Api?.company == null ? "" : Api?.company}
                        >
                          {Api?.company == null
                            ? "Not Available"
                            : Api?.company}
          ...
          <span className="text-[30px] mx-auto mt-[5%] font-bold">Loading</span>
        )}
